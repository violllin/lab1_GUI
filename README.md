...
Строка: let calc = { (a: Int) -> Int in return (5 + 10) * 2 };
![REZ1.png](images/REZ1.png)

Строка: let calc = { (a: Int) -> Int in return (a * 1) + 0 };
![REZ2.png](images/REZ2.png)

Строка: let calc = { (a: Int) -> Int in return (10 + 20) * (5 - 3) + (100 / 2) };
![REZ3.png](images/REZ3.png)
