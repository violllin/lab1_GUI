...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.output_panel.errors_table.cellClicked.connect(
            lambda r, c: self.controller.on_table_item_clicked(self.output_panel.errors_table, r))
        self.output_panel.errors_table.cellClicked.connect(
            lambda r, c: self.controller.on_table_item_clicked(self.output_panel.errors_table, r))
        self.output_panel.lexer_table.cellClicked.connect(
            lambda r, c: self.controller.on_table_item_clicked(self.output_panel.lexer_table, r))
    ...
    def setup_menu(self):
        ...
        self.menu_run.addAction(self.actions.antlr_run_act)
